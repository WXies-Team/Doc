...
| 参数 | 说明 | 类型 | 必填 | 示例 |
| --- | --- | --- | --- | --- |
| qqg | 需要获取头像的 QQ 群号 | string | 是 | `746950948` |
...
```
https://api.horatio.cn/avatar/qqg.php?qqg=746950948
```
...
```
https://api.horatio.cn/avatar/qqg.php?qqg=746950948&s=2
```
